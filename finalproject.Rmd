...
## Data Download/Loading Preparation
...
Convert characters to numeric values. For readmission, readmission time was not accounted for to simplify the problem. (Readmission >30 and <30 days after visit treated the same)
```{r}
...
data_dropped_na_omitted
```
Of the remaining columns, here are the continuous ones:
